...
class DnnlPostOpsComposerNew {
public:
    DnnlPostOpsComposerNew(const PostOps& postOps,
...
private:
    ...
    bool appendAttrPostOps(const FakeQuantizePostOp& postOp, bool isLastPostOp, bool doRounding, bool allowBinary = true);
