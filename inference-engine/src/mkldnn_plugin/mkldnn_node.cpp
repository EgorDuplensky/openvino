...
void MKLDNNNode::fillScalesAndShifts(const MKLDNNNodePtr& parentNode,
    ...
    const size_t bufferSize = static_cast<size_t>(outputShapes[0].getStaticDims()[outputShapes[0].getRank() > 1 ?
                                                                                  parentNode->getChannelAxis() : 0]);
    if (align == -1) {
        align = bufferSize;
    }
