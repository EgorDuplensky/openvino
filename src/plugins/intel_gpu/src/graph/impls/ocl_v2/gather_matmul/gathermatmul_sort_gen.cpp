...
JitConstants GatherMatmulSortGenerator::get_jit_constants(const kernel_impl_params& params) const {
    ...
    jit.add(make_layout_jit_constants("INPUT0", params.input_layouts[gather_matmul::BGMInputIdx::INDICES],
    ...
    LayoutJitter indices_jitter(params.input_layouts[gather_matmul::BGMInputIdx::INDICES],
                                in_offsets_map.at(gather_matmul::BGMInputIdx::INDICES));
    LayoutJitter weight_jitter(params.input_layouts[gather_matmul::BGMInputIdx::WEIGHT],
